...
export const OrderModal = ()=>{
    ...
    return (
        <div className={s.modal} onClick={nadleCloseModal}>
            <div className={s.body} onClick={handleModalClick}>
                ...
                <ul className={s.customer}>
                    ...
                    {values?.delivery==="delivery" && <li className={s.customerItem}>
                ...
                <button className={s.close} onClick={nadleCloseModal}></button>
            </div>
        </div>
    )
}